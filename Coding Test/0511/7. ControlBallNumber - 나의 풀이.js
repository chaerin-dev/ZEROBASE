/*
[문제 설명]
int 배열 array가 주어집니다. array는 숫자가 오름차순으로 정렬되어 있습니다.
array와 동일한 배열 newArray를 다음 규칙에 따라 생성합니다.
...
배열 array와 같은 newArray를 생성하기 위해 수행해야하는 기능을 배열로 출력하는 함수,
solution을 완성해주세요.
...
function solution(array) {
  ...
  while (i <= array[0]) {
    answer.push("In");
    if (i === array[0]) array.shift();
    else answer.push("Out");
    i++;
  }
  answer.push("End");
  return answer;
